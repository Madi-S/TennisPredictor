...
def get_predictions(html):
    ...
    print(f'Overall betting tendency: W1 - {w1} and W2 - {w2} and TO - {to} and TU - {tu}\n')

    predictions = {'Players': players, 'BetsTendency': {
        players[0]: w1, players[1]: w2, 'TotalOver': to, 'TotalUnder': tu},
        'PastResults': {}, 'Predictions': []}
    ...
    for pred in preds:
        try:
            ...
            print(f'Expert stats (this month profit): {expert_stats}\nOutcome: {outcome}\nOdds: {odds}\nExplanation: {explanation}')
            print('\n\n')
